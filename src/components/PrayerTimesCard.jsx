      ...
      <div className="relative h-screen bg-cover mx-auto -mt-20 md:-mt-32">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col justify-center items-center mb-8 md:mb-7">
                  ...
                  <h1 className='text-lg lg:text-xl text-white text-center'>Learn the language of the Quran</h1>
              </div>
              ...
              <div className="relative z-10 flex flex-col justify-center items-center mb-8 md:mb-7">
                  ...
                  <h1 className='text-lg lg:text-xl text-white text-center'>Stay updated on our latest programs</h1>
              </div>
              ...
              <div className="relative z-10 flex flex-col justify-center items-center mb-8 md:mb-7">
                  ...
                  <h1 className='text-lg lg:text-xl text-white text-center'>Deepen your knowledge of Islam</h1>
              </div>
