...
const Overview = () => {
  return (
    ...
    <div className="col-span-1 flex flex-col items-center text-center md:text-left">
      <p className="uppercase text-2xl mb-4">Building a Stronger Community</p>
      <h1 className="bg-gradient-to-r text-green-800 text-5xl py-6 from-green-700 to-black text-transparent bg-clip-text mb-8">
        Empowering Muslims, Enriching {" "}
        <span>Lives</span>
      </h1>

      <p className="mt-1 mb-7 w-full text-sm md:text-base">
