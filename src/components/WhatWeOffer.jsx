    ...
    >
      ...
      <div className="max-w-full flex flex-col md:flex-row justify-center items-center gap-0">
        ...
        >
          <div className="bg-green-700 rounded-lg shadow-lg p-4 md:p-6 lg:p-8">
            <div className="flex items-center mb-4">
              <i className="fas fa-book text-3xl text-white mr-4"></i>
              <h3 className="text-2xl font-bold text-white">Arabic Classes</h3>
            </div>
            <p className="text-lg text-white mb-4 md:text-xl lg:text-2xl">
        ...
        <motion.div
          ...
          className="w-full md:w-1/3 xl:w-1/3 p-6 lg:p-10 md:mx-2 lg:mx-2 md:p-0 mx-0"
        >
          <div className="bg-green-700 rounded-lg shadow-lg p-4 md:p-6 lg:p-8">
            <div className="flex items-center mb-4">
              <i className="fas fa-microphone text-3xl text-white mr-4"></i>
