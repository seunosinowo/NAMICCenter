...
const About = () => {
  return (
    <div className="bg-gray-100 p-4 md:p-6 lg:p-8 mb-4">
      <h2 className="text-2xl md:text-3xl font-bold mb-4 text-green-800">About Us</h2>
      <div className="flex flex-wrap justify-center mb-4">
        <div className="w-full md:w-1/2 xl:w-1/2 p-4">
          <h3 className="text-lg font-bold mb-2 text-green-800">Our History</h3>
          <p className="text-gray-600 mb-2">Nigeria American Muslim Integrated Community Center (NAMIC) was established in 2010 with the goal of providing a welcoming and inclusive environment for Muslims to practice their faith and connect with their community.</p>
        ...
        <div className="w-full md:w-1/2 xl:w-1/2 p-4">
          ...
          <ul className="list-none pl-0 mb-2">
            ...
            <li className="flex items-center mb-2">
              ...
              <span className="text-gray-600">801 Dean Street, Brooklyn, NY 11238</span>
            </li>
          </ul>
        </div>
        <div className="w-full md:w-1/2 xl:w-1/2 p-4">
          ...
          <li className="flex items-center mb-2">
            ...
            <span className="text-gray-600">facebook.com/namic.org</span>
            </li>
            <li className="flex items-center mb-2">
            <span className="text-lg font-bold mr-2">Twitter:</span>
            <span className="text-gray-600">twitter.com/namic_org</span>
            </li>
            <li className="flex items-center mb-2">
            <span className="text-lg font-bold mr-2">Instagram:</span>
            <span className="text-gray-600">instagram.com/namic_org</span>
            </li>
            </ul>
            </div>
            </div>
            ...
            <button className="bg-green-800 hover:bg-green-950 text-white font-bold py-2 px-4 rounded">Donate Now</button>
            </div>
            <div className="w-full md:w-1/2 xl:w-1/2 p-4">
            <h3 className="text-lg font-bold mb-2 text-green-800">Volunteer</h3>
            <p className="text-gray-600 mb-2">Join our team of dedicated volunteers and help us make a difference in our community.</p>
            <button className="bg-green-800 hover:bg-green-950 text-white font-bold py-2 px-4 rounded">Volunteer Now</button>
            </div>
            </div>
            </div>
            );
